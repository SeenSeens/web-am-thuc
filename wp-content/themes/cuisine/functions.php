<?php
/**
 * cuisine functions and definitions
 *
...
if ( ! function_exists( 'cuisine_setup' ) ) :
	...
	function cuisine_setup() {
		 ...
		 * If you're building a theme based on cuisine, use a find and replace
		 * to change 'cuisine' to the name of your theme in all the template files.
		 */
