<?php
/*
 * Template Name: Gallery Design 2
 */
?>
<?php get_header(); ?>
...
<section class="chopcafe_gallery chopcafe_gallery_3 section_padding" id="chopcafe_gallery">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="grid_row row">
          ...
          ?>
            <div class="col-lg-4 col-md-6 col-sm-12 gallery_item <?php echo strtolower($tax); ?>">
                <div class="grid_item">
